 ...
 * Estructura idéntica al AdminLayout, ahora completamente responsiva.
 */
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <div className="relative z-10">
            <ManagerSidebar setSidebarOpen={setSidebarOpen} />
          </div>
        </div>
      )}
      ...
      <main className="flex-1 relative z-10 overflow-y-auto min-w-0">
        ...
        <div className="lg:hidden flex items-center justify-between p-4 border-b border-border/30 bg-surface/80 backdrop-blur-xl sticky top-0 z-30">
          ...
          <button
            ...
            className="w-11 h-11 rounded-xl border border-border/50 bg-carbon flex items-center justify-center cursor-pointer"
          >
            <Menu size={20} />
          </button>
